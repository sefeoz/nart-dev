function About(){
    return(<>
        <section className="site-6xl-container mt-16">
            ...
            <p className="text-gray-200 text-center text-3xl font-thin mt-5">Nart Yazılım Olarak Gelecek İçin Çalışmaktan Gurur Duyuyoruz.</p>
            <div className={"bg-white p-10 my-10 rounded-xl"}>
                <p className={"text-3xl font-extrabold text-gray-800"}>Nart Yazılım, 2022 yılında Nart tarafından kurulmuş bağımsız bir yazılım şirketidir.</p>
                <p className={"text-xl mt-5 font-light text-gray-700"}>Nart Yazılım'ın amacı geleceği herkese hazır hale getirebilmek için dünyadaki herkesin yazılım ile bilgilendirilmesi ve herkese bu gelecekte birer yer verilmesidir. Bunun için herkesi yazılım gibi çeşitli teknolojik alanlarda onlara bir olanak ve yardımcı bir alan oluşturmaktadır.</p>
            </div>
        </section>
            {/*<----------------------------SECTION END------------------------------------------------------>*/}
            <section className="site-6xl-container pb-20">
                ...
                <div className="lg:grid grid-cols-3 mt-10">
                    <div className="mt-10">
                        <h1 className={"text-nav-green text-8xl text-center"}>28M</h1>
                        <p className="text-white text-3xl text-center mt-10 font-bold">Kod Satırı</p>
                    </div>
                    <div className={"mt-10"}>
                        <h1 className={"text-nav-green text-8xl text-center"}>5</h1>
